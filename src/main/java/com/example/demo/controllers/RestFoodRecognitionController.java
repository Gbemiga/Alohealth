...
@RestController
@RequestMapping("/api/foodRecognition")
public class RestFoodRecognitionController {


    @RequestMapping(value = "/sendData", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity<Map> sendData(@RequestBody byte[] pRequest) throws IOException {
        String urlTo = "https://api-2445582032290.production.gw.apicast.io/v1/foodrecognition?user_key=ca87e5d9c66edd528225645ece8826d4";
        String result = null;
...
//        params.put("bar", "");
//
//        String fileLocation = ((StandardMultipartHttpServletRequest) pRequest).getMultiFileMap().get("picture").get(0).getInputStream().;
//
//        try {
